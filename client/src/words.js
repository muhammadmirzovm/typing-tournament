// MonkeyType-style word pool: the ~200 most common English words.
// These form passages with no sentence meaning — pure typing practice.
export const WORDS = [
...
// Build a passage of `count` random words joined by spaces.
export function generateText(count = 30) {
  const words = [];
